...
export const articles: Article[] = [
  {
    ...
    body: [
      ...
      "For buyers evaluating CyberReady, the current-event relevance is straightforward. CyberReady packages CCRR/CEAM cybersecurity assessment, CAGR AI-governance assessment, CAIRE evidence review, and Hall Monitor reporting into a governance workflow that helps districts organize these questions before an incident forces them into view. The opportunity is not to promise prevention. It is to provide repeatable structure for visibility, readiness, accountability, and improvement.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "CyberReady's CCRR/CEAM cybersecurity assessment evaluates governance domains such as policy, oversight, vendor risk management, incident response, mitigation, recovery, and communication. These domains help districts see resilience as a lifecycle. The goal is to prepare before a vendor or district incident becomes a public crisis.",
