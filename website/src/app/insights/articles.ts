...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "CyberReady addresses this gap through CAGR and CAIRE. CAGR organizes AI governance maturity across NIST AI RMF functions. CAIRE gives evaluators a way to validate maturity through evidence. Hall Monitor provides a place to document AI systems, ratings, notes, and improvement guidance so governance can become operational rather than aspirational.",
