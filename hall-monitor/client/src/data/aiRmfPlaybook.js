// Generated from NIST AI RMF Playbook (NIST AI 100-1)
// 72 subcategory entries across GOVERN, MAP, MEASURE, MANAGE

export const AIRMF_PLAYBOOK = [
  {
    "title": "GOVERN 1.1",
    "function": "Govern",
    "category": "GOVERN-1",
  ...
  },
  {
    ...
    "about": "To enhance AI risk management adoption and effectiveness, organizations are encouraged to identify and integrate appropriate training curricula into enterprise learning requirements. Through regular training, AI actors can maintain awareness of:\n\n- AI risk management goals and their role in achieving them.\n- Organizational policies, applicable laws and regulations, and industry best practices and norms.\n\nSee [MAP 3.4]() and [3.5]() for additional relevant information.",
    "actions": [
  ...
  },
  {
    ...
    "about": "To mitigate the potential harms of third-party system failures, organizations may implement policies and procedures that include redundancies for covering third-party functions.",
    "actions": [
  ...
  },
  {
    ...
    "about": "AI systems – like any technology – can demonstrate non-functionality or failure or unexpected and unusual behavior. They also can be subject to attacks, incidents, or other misuse or abuse – which their sources are not always known apriori. Organizations can establish, document, communicate and maintain treatment procedures to recognize and counter, mitigate and manage risks that were not previously identified.",
    "actions": [
  ...
  },
  {
    ...
    "about": "AI actors define the technical learning or decision-making task(s) an AI system is designed to accomplish, or the benefits that the system will provide. The clearer and narrower the task definition, the easier it is to map its benefits and risks, leading to more fulsome risk management.",
    "actions": [
  ...
  },
  {
    ...
    "about": "Documenting measurement approaches, test sets, metrics, processes and materials used, and associated details builds foundation upon which to build a valid, reliable measurement process.  Documentation enables repeatability and consistency, and can enhance AI risk management decisions.",
    "actions": [
  ...
  },
  {
    ...
    "about": "Risks identified in the Map function may be complex, emerge over time, or difficult to measure. Systematic methods for risk tracking, including novel measurement approaches, can be established as part of regular monitoring and improvement processes.",
    "actions": [
...
export function getPlaybookEntry(subcategoryTitle) {
  return AIRMF_PLAYBOOK.find(e => e.title === subcategoryTitle)
    ?? null;
}

export function getPlaybookForCategory(categoryId) {
  return AIRMF_PLAYBOOK.filter(e => e.categoryId === categoryId);
}
